...
This is an xml document generator server that generates a random xml document per request as an http xml response. This project is being used for automated testing purposes of the [xml parser](../../../xml-parser) project. There are two implementations to get a document for now. One implementation is generated by the Microsoft Copilot. Both implementations are modified to comply with the testing purposes. You can use the following urls dedicated to each implementation separately as below:
